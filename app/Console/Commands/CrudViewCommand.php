...
class CrudViewCommand extends Command
{
    ...
    public function handle() {
        ...
        $this->modelNameTitle = str_replace(' ', ucfirst($this->argument('name')), $this->argument('name'));
        ...
        $this->viewName = Str::singular(Str::snake($this->argument('name'), '-'));
    ...
    protected function wrapField($item, $field) {
        ...
        if ($this->option('localize') == 'yes') { $labelText = 'trans(\'' . $this->crudName . '.' . $item['name'] . '\')'; }
