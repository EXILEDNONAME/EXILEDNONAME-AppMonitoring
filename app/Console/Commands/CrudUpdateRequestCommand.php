...
class CrudUpdateRequestCommand extends GeneratorCommand {

  protected $signature = 'crud:updaterequest
  ...
  protected function getStub() {
    ...
    ? config('crudgenerator.path') . '/update-request.stub'
    : __DIR__ . '/../stubs/controller.stub';
  }

  protected function getDefaultNamespace($rootNamespace) {
    return $rootNamespace . ($this->option('updaterequest-namespace') ? $this->option('updaterequest-namespace') :  $this->option('updaterequest-namespace') );
  }
